...
public class MessungLinkedList {
	...
	private static final Logger LOGGER = LogManager.getLogger(MessungLinkedList.class);
	...
	public MessungLinkedList() {
		...
		LOGGER.info(String.format("%s mit %s Einträgen erstellt", LISTENTYP, liste.size()));
	}
